...
def ewma_forecasting(returns, lambda_=0.94):
    ...
    adjusted_volatility = current_volatility

    return adjusted_volatility


def gjr_garch_forecasting(returns):
    ...
    adjusted_volatility = last_conditional_volatility
